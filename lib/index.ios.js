...
class ReactNativePickerModule extends React.Component {
  ...
  render() {
    const { value, items, title, onValueChange, pickerRef, ios, cancelButton, confirmButton, onCancel } = this.props;
    pickerRef({
      show: () => {
        this.setState({
          isVisible: true,
            ...
            <View style={styles.content}>
              ...
              <TouchableOpacity activeOpacity={.9} onPress={() => {
                if (this.state.selectedValue === null || this.state.selectedValue !== this.props.value) {
                  ...
                  const value = isNull ? items[0] : items[valueIndex];
                  ...
                  Animated.timing(this.state.animation, {
                    ...
                    this.setState({
                      ...
                      this.props.onDismiss !== undefined && this.props.onDismiss();
                    });
                  });
                }
              }}>
