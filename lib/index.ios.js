...
class ReactNativePickerModule extends React.Component {
  ...
  render() {
    const {value, items, title, onValueChange, spinnerRef, ios, cancelButton, confirmButton} = this.props;
    spinnerRef({
      show: () => {
        this.setState({
          isVisible    : true,
            ...
            <Animated.View style={styles.container}>
              <View style={styles.content}>
                ...
                <TouchableOpacity activeOpacity={.9} onPress={() => {
                  onValueChange(this.state.selectedValue);
                  Animated.timing(this.state.animation, {
                    toValue : 0,
                    duration: ios.duration,
                  }).start(() => {
                  ...
                  <View style={[styles.confirmButtonView, {
                    opacity: this.state.selectedValue !== this.props.value ? 1 : 0.1
                  }]}>
